<%-- 
    Document   : activom
    Created on : 26/03/2017, 06:42:12 PM
    Author     : dell
--%>
...
//String b = (String) session.getAttribute("pass");
 ...
 String ids = (String) session.getAttribute("idactim"); 
        %>
        ...
        <script type="text/javascript">
            ...
            // app.dosomething(x);
                document.getElementById("descmod").innerHTML= "";
 ...
 System.out.println(ss);
        ...
        %>
              <select name="dropdown2" id="dropdown2" onchange="feedtext()">
         <%=ss%> 
        </select>
     <input  type="submit" name="refresmod" value="Refresh" class="btn btn-primary">
     
    </center>
     <br>
     <% 
 String name = (String) session.getAttribute("nommod"); 
        %>
        ...
        <table align="center">
            <tr> 
               <td colspan="2" align="center" placeholder="Username"> 
                      <% 
 String texts = (String) session.getAttribute("descmod"); 
        %>
       <textarea name="descm" rows="4" cols="50" id="descel">
<%=texts%>
</textarea></td>
            </tr>
            <tr> 
                  <td colspan="2" align="center"> <input  type="submit" name="btnmodificaract" value="Modificar Activo" class="btn btn-primary"></td>
            </tr>
            <tr><td>
                    <br>
                </td></tr>
